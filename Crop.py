...
DATASET_PATH = os.getenv("DATASET_PATH") + "/AIDE_Dataset"

annotation_directory = os.path.join(DATASET_PATH, "annotation")

process_data(DATASET_PATH, annotation_directory, start_from=1)
